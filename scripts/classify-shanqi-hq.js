...
async function classifyShanqiHQText() {
  try {
    console.log('开始分类高质量陕汽PDF的OCR文本...\n');

    const dataPath = path.join(__dirname, 'shanqi-hq-all-text-data.json');
    ...
    const outputPath = path.join(__dirname, 'shanqi-hq-classified-data.json');
